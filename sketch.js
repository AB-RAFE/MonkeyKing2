...
function draw() {
  ...
  if(gameState === PLAY) {
    ...
    touch.visible = false;
      ...
      if(keyDown("space")||mousePressedOver(touch)&& monkey.y >= 300) {
        monkey.velocityY = -18;
        jumpSound.play();
      }
...
function food() {
  if(frameCount % 180 === 0) {
    var banana = createSprite(800,0,20,20);
...
function obstacles() {
  if(frameCount % 300 === 0) {
    var stone = createSprite(820,315,20,20);
